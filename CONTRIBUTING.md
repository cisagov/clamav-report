...
issue](https://github.com/cisagov/clamav-report/issues) in
...
request](https://github.com/cisagov/clamav-report/pulls),
...
```console
cd clamav-report
pyenv virtualenv <python_version_to_use> clamav-report
pyenv local clamav-report
